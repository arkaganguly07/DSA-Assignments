/*
Q4> Write a program to implement multiple queues in a single array.
*/
...
Element to be entered in queue number 0 : 23
23 is inserted in queue number 0.

Choose operation : 1

Enter logical queue number (0 to 1) : 0
Element to be entered in queue number 0 : 65
65 is inserted in queue number 0.

Choose operation : 1

Enter logical queue number (0 to 1) : 1
Element to be entered in queue number 1 : 67
67 is inserted in queue number 1.

Choose operation : 1

Enter logical queue number (0 to 1) : 1
Element to be entered in queue number 1 : 89
89 is inserted in queue number 1.
