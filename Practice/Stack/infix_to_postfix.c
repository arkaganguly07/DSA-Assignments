...
// Stack type (Capacity of the stck is not determined)
struct Stack {
	int top;
	unsigned capacity;  // An unsigned Integer means the variable can hold only a positive value.
	int* array;
};
...
int main()
{
    ...
    length = sizeof(exp) / sizeof(exp[0]);
    printf("\nInfix Expression\n");
